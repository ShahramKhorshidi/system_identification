...
if __name__ == "__main__":
    ...
    data_path = os.path.join(parentDirPath, "data/spot/")
    model_path = os.path.join(parentDirPath,"data/runs/Nets/340714.Sep.18.37_estimator_2048_NO_GAUS_1e-06_512", "epoch 1000.dat")
